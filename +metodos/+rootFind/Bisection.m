classdef Bisection < metodos.rootFind.Base
    ...
    methods
        function obj = Bisection(a, b, tol, f, options)
            ...
            obj@metodos.rootFind.Base(a, b, tol, f, check_critical_points=options.check_critical_points, absolute_error=options.absolute_error)
